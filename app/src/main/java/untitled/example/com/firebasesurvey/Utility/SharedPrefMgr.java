...
public class SharedPrefMgr
{
	 ...
	 */
	public static Flowable<Integer> loadSharedPrefListioner(Context context, String searchKey, int value, String category) {
		SharedPreferences sharedPref = context.getSharedPreferences(category, Context.MODE_PRIVATE);
	 ...
	 */
	public static Flowable<Long> loadSharedPrefListioner(Context context, String searchKey, long value, String category) {
		SharedPreferences sharedPref = context.getSharedPreferences(category, Context.MODE_PRIVATE);
	 ...
	 */
	public static Flowable<Boolean> loadSharedPrefListioner(Context context, String searchKey, boolean value, String category) {
		SharedPreferences sharedPref = context.getSharedPreferences(category, Context.MODE_PRIVATE);
	 ...
	 */
	public static Flowable<String> loadSharedPrefListioner(Context context, String searchKey, String value, String category) {
		SharedPreferences sharedPref = context.getSharedPreferences(category, Context.MODE_PRIVATE);
	 ...
	 */
	public static Flowable<Bundle> loadSharedPrefListioner(Context context, String searchKey, String category)
	{
		SharedPreferences sharedPref = context.getSharedPreferences(category, Context.MODE_PRIVATE);
